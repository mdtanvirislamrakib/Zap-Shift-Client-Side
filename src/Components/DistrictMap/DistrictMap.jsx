...
// Fix Leaflet marker icon issue for React 18+
...
// ✅ Your 64 district data (paste the full array into a separate file ideally)
const districtData = [
  {
    "region": "Dhaka",
    "district": "Dhaka",
...
const DistrictMap = () => {
  // Center the map roughly around Bangladesh
  const bangladeshCenter = [23.685, 90.3563];

  return (
    <div className="w-full h-[600px] rounded-xl overflow-hidden shadow-lg my-10">
      <MapContainer
      ...
      >
        ...
        {/* 🔁 Generate marker for each district */}
